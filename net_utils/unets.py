...
# NOTE: Added by me - it differs from the original 'ConvBlock' class JUST for the positon of the normalization
class FusionConvBlock(nn.Module):
    """ Final fusion convolutional layers after multiple decoder path. """
...
class TUNet(nn.Module):
    ...
    def __init__(self, ch_in=1, ch_out=1, pool_method='conv', act_fun='relu', normalization='bn', filters=(64, 1024), detach_fusion_layers = False):
        ...
        # NOTE: Additional fusion layers and final segmentation mask conv layer
